...
<div style="background-color: navy; color: white; position: fixed; top:200; width: 100%; height: 40%;"> <h1>Share by Instructions:</h1>
<h3> Instructions: </h3>
<h4>1. Go to https://privatechat--roycea.repl.co <br>
2. In the chat name entry type in "<?php echo " $room "?>", and let your friends join.
</div>
...
<thead>
<center style="background-color: #31A4E1;"><p style="font-size:200%; font-family: sans-serif; color: white; margin:0;">Private Chat.io</p></center>
</thead>
<tbody>
	<tr>
	...
	<tr>
		<td style="font-family: sans-serif;font-size: 17pt;text-align: left; width: 432px; color: white;"><center>Chat name:</center></td>
		<td style="font-family: sans-serif; font-size: 17pt; text-align: left; color: #31A4E1; width: 100px;">
		<center><input type="text" name="rname" maxlength="10"></center></td>
	</tr>
	<tr>
...
body {
  ...
  background-image: url("https://cdn.pixabay.com/photo/2019/03/29/15/32/beautiful-4089424_960_720.jpg");
